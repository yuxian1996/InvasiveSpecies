...
public class MouseBehaviour1 : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        speechBubbleRect = new Rect(screenPos.x - 80, screenPos.y - 120, 100, 100);
    }
    ...
    public void Update()
    {
        ...
        infoWindowRect.x = screenPos.x + 20;
        infoWindowRect.y = screenPos.y;

        speechBubbleRect.x = screenPos.x - 80;
        speechBubbleRect.y = screenPos.y - 120;
    }
